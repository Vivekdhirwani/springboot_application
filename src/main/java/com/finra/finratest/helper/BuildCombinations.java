...
public class BuildCombinations {
    ...
    public static void makeCombinations(String inputString, List<String> result, List<List<Character>> keypadList,
        ...
        for (int i = 0; i < length; i++) {
            makeCombinations(inputString, result, keypadList, numberArray, keypadList.get(digit).get(i) + resultString,
                    index - 1);
        }
    }
    ...
    public ResponseEntity<Object> possibleCombination(String inputString) throws JSONException {
        ...
        makeCombinations(inputString, result, keypadList, numbersArr, "", numbersArr.length - 1);
